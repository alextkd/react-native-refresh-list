import React, {createElement, isValidElement, PropTypes} from 'react';
import {
    View,
    Text,
...
export default class RefreshingIndicator extends React.Component {
    static propTypes = {
    ...
    render() {
        let styles = Object.assign({}, stylesheet, this.props.stylesheet);
